...
export const tequilas: Array<Tequila> = [
  {
    ...
    description:
      "Nose: Crisp agave aromas blended with hints of citrus notes, lemon, lime and grapefruit. Taste: Light, sweet, agave flavor. Finish: Light, sweet, agave flavor",
    about:
  ...
  },
  {
    ...
    description:
      "This light, crystal clear tequila with fresh agave aromas and hints of citrus is a favorite of tequila connoisseurs worldwide. Its smooth and sweet taste with a light pepper finish mixes flawlessly into most any cocktail.",
    about:
      "Our entire tequila-making process takes place at Hacienda Patron, where we only make Patron. And we take pride in everything about it. From our eco-friendly reverse osmosis irrigation system to the agave byproduct we recycle. And most importantly, in the people involved in making our tequila - 60 hands from beginning to end.",
  ...
  },
  {
    ...
    about:
      "We hand-select the finest 100% Blue Weber agaves, grown in the rich red clay soil and cool climate of the Highlands of Jalisco, Mexico. Slow Cooking: Our agave pinas are roasted in traditional brick ovens for 72 hours. We love Casamigos on the rocks, by the shot and at times straight from the bottle. Our idea was to create the best tasting, smoothest Tequilas and Mezcal, that don't have to be covered up with salt or lime. So, we did.",
